                    ...
                    <div class="col-md-6">
                       ...
                       <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url(); ?>home/save_contact">
                                  ...
                                  <div class="form-group">
                                    <label>Mobile</label>
                                    <input type="text" class="form-control" name="mobile" value="<?php echo $this->session->userdata('mobile'); ?>" />
                                    <?php 
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="description"><?php echo $this->session->userdata('description'); ?></textarea>
                                  </div>
                                  <div class="form-group">
